        ...
        <div className="container---main">
          <div className="content-long">
            <h1 className="title-large">
              Let’s turn your vision into a reality that inspires and connects.
            </h1>
          </div>
        </div>
      </section>
            ...
            >
              <div className="form-section">
                <div className="form-section-text">
                  ...
                  <div className="large-text muted-text">
                    ...
                    and context. Help us understand your vision and what success
                ...
                <div className="form-inputs">
                  ...
                  <div className="input-group">
                    <label htmlFor="Project-Name-2" className="input-label">
                      Project Context <span className="required-field">*</span>
                    </label>
                    <textarea
              ...
              <div className="form-section">
                <div className="form-section-text">
                  ...
                  <div className="large-text muted-text">
                    ...
                    shape the right approach. Share the key parameters that will
                ...
                <div className="form-inputs">
                  ...
                  <div className="input-group">
                    <label htmlFor="Deliverables" className="input-label">
                      Key deliverables <span className="required-field">*</span>
                    </label>
                    <textarea
                      placeholder="Tell us a little about your project and what prompted this initiative"
                      maxLength={5000}
                  ...
                  <div className="input-group">
                    <label htmlFor="Deliverables-2" className="input-label">
                      Target Platforms <span className="required-field">*</span>
                    </label>
              ...
              <div className="form-section">
                <div className="form-section-text">
                  ...
                  <div className="large-text muted-text">
                    Please review your information and agree to our consultation
                    terms.
                  </div>
                </div>
                <div className="form-inputs">
                  ...
                  <label className="w-checkbox checkbox-field">
                    ...
                    <span
                      ...
                      // htmlFor="Agree-1"
                    >
                      I understand that submitted information will be handled in
                      accordance with Andersen's privacy policy. While we aim to
                      respond within 48 hours, complex requests may require
                      additional time.
                    </span>
                  </label>
                  <label className="w-checkbox checkbox-field">
